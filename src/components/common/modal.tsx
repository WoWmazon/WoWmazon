      ...
      {show && (
        ...
        >
          ...
          >
            ...
            <h3 className="mb-5 text-lg font-normal text-ELSE-55">{content}</h3>
            <div className="flex w-full h-14">
              {optionalBtnText && (
                <button
                  onClick={handleOptional}
                  className="mr-3 p-[15px] text-lg font-bold text-ELSE-F8 bg-white border border-ELSE-2C rounded-sm hover:bg-gray-100 hover:text-gray-500 flex-1"
                >
                  {optionalBtnText}
                </button>
              )}
